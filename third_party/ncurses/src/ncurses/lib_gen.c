...
NCURSES_EXPORT(int) attrset(int z) {
  ...
  returnIntAttr((attr_t)(
      (0 != (const void *)((stdscr)))
          ? ((stdscr)->_color = (int)(((int)((
                 ((unsigned long)(((z))) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >> 8)))),
             (stdscr)->_attrs = (attr_t)((z)), (0))
          : (-1)));
}
...
NCURSES_EXPORT(int) attr_get(attr_t *a1, short *a2, void *z GCC_UNUSED) {
  ...
  returnCode(
      ((0 != (const void *)((stdscr)))
           ? ((void)((0 != (const void *)(((a1)))) ? (*((a1)) = (stdscr)->_attrs) : (0)),
              (void)((0 != (const void *)(((a2)))) ? (*((a2)) = (short)(stdscr)->_color) : (0)),
              (void)((0 != (const void *)(((z)))) ? (*(int *)((z)) = (stdscr)->_color) : (0)), (0))
           : (-1)));
}
...
NCURSES_EXPORT(int) attr_set(attr_t a1, short a2, void *z GCC_UNUSED) {
  ...
  returnCode(
      ((0 != (const void *)((stdscr)))
           ? ((void)((stdscr)->_attrs = (((a1)) & ~((chtype)((((1U) << 8) - 1U)) << ((0) + 8))),
                     (stdscr)->_color = ((z)) ? *(int *)((z)) : ((a2))),
              (0))
           : (-1)));
}
...
NCURSES_EXPORT(int)
border(chtype a1, chtype a2, chtype a3, chtype a4, chtype a5, chtype a6, chtype a7, chtype z) {
  T((T_CALLED("border(%s,%s,%s,%s,%s,%s,%s,%s)"), _tracechtype2(0, a1), _tracechtype2(1, a2),
     _tracechtype2(2, a3), _tracechtype2(3, a4), _tracechtype2(4, a5), _tracechtype2(5, a6),
     _tracechtype2(6, a7), _tracechtype2(7, z)));
...
NCURSES_EXPORT(int) innstr(char *a1, int z) { return winnstr(stdscr, (a1), (z)); }
...
NCURSES_EXPORT(int) mvaddchnstr(int a1, int a2, const chtype *a3, int z) {
  ...
  returnCode(
      (wmove((stdscr), ((a1)), ((a2))) == (-1) ? (-1) : waddchnstr((stdscr), ((a3)), ((z)))));
}
...
NCURSES_EXPORT(int) mvchgat(int a1, int a2, int a3, attr_t a4, short a5, const void *z) {
  T((T_CALLED("mvchgat(%d,%d,%d,%s,%#lx,%p)"), a1, a2, a3, _traceattr2(3, a4), (long)a5,
     (const void *)z));
  returnCode((wmove((stdscr), ((a1)), ((a2))) == (-1)
                  ? (-1)
                  : wchgat((stdscr), ((a3)), ((a4)), ((a5)), ((z)))));
}
...
NCURSES_EXPORT(int)
mvwchgat(WINDOW *a1, int a2, int a3, int a4, attr_t a5, short a6, const void *z) {
  T((T_CALLED("mvwchgat(%p,%d,%d,%d,%s,%#lx,%p)"), (const void *)a1, a2, a3, a4, _traceattr2(4, a5),
     (long)a6, (const void *)z));
...
NCURSES_EXPORT(int) standout(void) {
  ...
  returnIntAttr((attr_t)(
      ((0 != (const void *)((stdscr)))
           ? ((stdscr)->_color = (int)(((int)((((unsigned long)((((chtype)((1U)) << ((8) + 8)))) &
                                                ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >>
                                               8)))),
              (stdscr)->_attrs = (attr_t)(((chtype)((1U)) << ((8) + 8))), (0))
           : (-1))));
}
...
NCURSES_EXPORT(int) standend(void) {
  ...
  returnIntAttr((attr_t)(
      ((0 != (const void *)((stdscr)))
           ? ((stdscr)->_color = (int)(((int)((
                  ((unsigned long)(((1U - 1U))) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >>
                  8)))),
              (stdscr)->_attrs = (attr_t)((1U - 1U)), (0))
           : (-1))));
}
...
NCURSES_EXPORT(int) wattrset(WINDOW *a1, int z) {
  ...
  returnIntAttr((attr_t)(
      (0 != (const void *)((a1)))
          ? ((a1)->_color = (int)(((int)((
                 ((unsigned long)((z)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >> 8)))),
             (a1)->_attrs = (attr_t)(z), (0))
          : (-1)));
}

NCURSES_EXPORT(int) wattr_get(WINDOW *a1, attr_t *a2, short *a3, void *z GCC_UNUSED) {
  T((T_CALLED("wattr_get(%p,%p,%p,%p)"), (const void *)a1, (const void *)a2, (const void *)a3,
     (const void *)z));
  returnCode(((0 != (const void *)((a1)))
                  ? ((void)((0 != (const void *)((a2))) ? (*(a2) = (a1)->_attrs) : (0)),
                     (void)((0 != (const void *)((a3))) ? (*(a3) = (short)(a1)->_color) : (0)),
                     (void)((0 != (const void *)((z))) ? (*(int *)(z) = (a1)->_color) : (0)), (0))
                  : (-1)));
}

NCURSES_EXPORT(int) wattr_set(WINDOW *a1, attr_t a2, short a3, void *z GCC_UNUSED) {
  T((T_CALLED("wattr_set(%p,%s,%#lx,%p)"), (const void *)a1, _traceattr2(1, a2), (long)a3,
     (const void *)z));
  returnCode(((0 != (const void *)((a1)))
                  ? ((void)((a1)->_attrs = ((a2) & ~((chtype)((((1U) << 8) - 1U)) << ((0) + 8))),
                            (a1)->_color = (z) ? *(int *)(z) : (a3)),
                     (0))
                  : (-1)));
}
...
NCURSES_EXPORT(int) wstandout(WINDOW *z) {
  ...
  returnIntAttr((attr_t)(
      ((0 != (const void *)((z)))
           ? ((z)->_color = (int)(((int)((((unsigned long)((((chtype)((1U)) << ((8) + 8)))) &
                                           ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >>
                                          8)))),
              (z)->_attrs = (attr_t)(((chtype)((1U)) << ((8) + 8))), (0))
           : (-1))));
}
...
NCURSES_EXPORT(int) wstandend(WINDOW *z) {
  ...
  returnIntAttr(
      (attr_t)(((0 != (const void *)((z)))
                    ? ((z)->_color = (int)(((int)((((unsigned long)(((1U - 1U))) &
                                                    ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >>
                                                   8)))),
                       (z)->_attrs = (attr_t)((1U - 1U)), (0))
                    : (-1))));
}
...
NCURSES_EXPORT(int) wgetscrreg(const WINDOW *a1, int *a2, int *z) {
  ...
  returnCode(
      ((0 != (const void *)((a1))) ? (*(a2) = (a1)->_regtop, *(z) = (a1)->_regbottom, (0)) : (-1)));
}
...
#if USE_WIDEC_SUPPORT
NCURSES_EXPORT(int)
border_set(const cchar_t *a1, const cchar_t *a2, const cchar_t *a3, const cchar_t *a4,
           const cchar_t *a5, const cchar_t *a6, const cchar_t *a7, const cchar_t *z) {
  T((T_CALLED("border_set(%p,%p,%p,%p,%p,%p,%p,%p)"), (const void *)a1, (const void *)a2,
     (const void *)a3, (const void *)a4, (const void *)a5, (const void *)a6, (const void *)a7,
     (const void *)z));
...
NCURSES_EXPORT(int) getbkgrnd(cchar_t *z) {
  ...
  returnCode(((0 != (const void *)(((z)))) ? ((stdscr) ? (*((z)) = (stdscr)->_bkgrnd) : *((z)), (0))
                                           : (-1)));
}
#endif
...
#if USE_WIDEC_SUPPORT
NCURSES_EXPORT(int) innwstr(wchar_t *a1, int z) { return winnwstr(stdscr, (a1), (z)); }
#endif
...
NCURSES_EXPORT(int) mvadd_wchnstr(int a1, int a2, const cchar_t *a3, int z) {
  ...
  returnCode(
      (wmove(stdscr, ((a1)), ((a2))) == (-1) ? (-1) : wadd_wchnstr((stdscr), ((a3)), ((z)))));
}
#endif
...
NCURSES_EXPORT(int) mvadd_wchstr(int a1, int a2, const cchar_t *z) {
  ...
  returnCode(
      (wmove(stdscr, ((a1)), ((a2))) == (-1) ? (-1) : wadd_wchnstr(((stdscr)), (((z))), -1)));
}
#endif
