...
http_archive(
    ...
    strip_prefix = "rules_haskell-56e42a95c7957ff57c227ad55f01c95ea986cd3a",
    urls = ["https://github.com/tweag/rules_haskell/archive/56e42a95c7957ff57c227ad55f01c95ea986cd3a.tar.gz"],
)
