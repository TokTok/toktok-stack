...
# Java toolchain.
build:rbe --extra_toolchains=@bazel_toolchain//java:all
build:rbe --host_javabase=@bazel_toolchain//java:jdk
build:rbe --javabase=@bazel_toolchain//java:jdk

# C/C++ toolchain.
build:rbe --extra_toolchains=@bazel_toolchain//config:cc-toolchain
build:rbe --crosstool_top=@bazel_toolchain//cc:toolchain

# Platform flags:
# The toolchain container used for execution is defined in the target indicated
# by "extra_execution_platforms", "host_platform" and "platforms".
# More about platforms: https://docs.bazel.build/versions/master/platforms.html
build:rbe --extra_execution_platforms=@bazel_toolchain//config:platform
build:rbe --host_platform=@bazel_toolchain//config:platform
build:rbe --platforms=@bazel_toolchain//config:platform
