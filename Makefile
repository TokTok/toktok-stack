IMAGE		= toxchat/toktok-stack:0.0.6
...
run:
	docker run --rm -it $(IMAGE) bazel build //...
...
BAZELFLAGS :=	\
	--per_file_copt="external/ffmpeg@-Wno-implicit-int-float-conversion"	\
	--per_file_copt="external/ffmpeg@-Wno-misleading-indentation"		\
	--per_file_copt="external/ffmpeg@-Wno-bool-operation"			\
	--per_file_copt="(moc_.*.cpp|_test.cpp)@-Wno-extra-semi-stmt"
